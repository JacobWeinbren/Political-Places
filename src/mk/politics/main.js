	...
	uniqueValueInfos: [
		{
			value: "Lab",
			label: "Labour",
			symbol: arrow.createArrowSymbol(new Color("#E4003B"), 45),
		},
		{
			value: "Con",
			label: "Conservative",
			symbol: arrow.createArrowSymbol(new Color("#0087DC"), -45),
		},
		{
			value: "LDem",
			label: "Liberal Democrats",
			symbol: arrow.createArrowSymbol(new Color("#FAA61A"), 0),
		},
		{
			value: "Grn",
			label: "Green",
			symbol: arrow.createArrowSymbol(new Color("#6AB023"), 45),
		},
		{
			value: "Ind",
			label: "Independent",
			symbol: arrow.createArrowSymbol(new Color("grey"), 0),
		},
		{
			value: "IndGrp",
			label: "Independent Group",
...
$.getJSON(
	"https://ancient-dawn-46f2.jacobweinbren.workers.dev/",
	function (data) {
